...
//===================================setVolumeLevel (à verifier)====================
document.getElementById('setVolLow').addEventListener('click', () => {
    this.volumeLevel= Number((this._player.volumeLevel));
    return volumeLevel-0.1;

});
document.getElementById('setVolHigh').addEventListener('click', () => {
    this.volumeLevel= Number((this._player.volumeLevel));
    return volumeLevel+0.1;})
//===================================INFO==============================
